...
public class TelaOS extends javax.swing.JInternalFrame {
    ...
    private void setar_campos() {
        ...
        txtCiId.setText(tblClientes.getModel().getValueAt(setar, 0).toString());
    }

    private void emitir_os() {
        String sql = "insert into tbos (tipo,situacao,equipamento,serie,defeito,servico,tecnico,valor,idcli) values (?,?,?,?,?,?,?,?,?)";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, tipo);
            pst.setString(2, cbOsSit.getSelectedItem().toString());
            pst.setString(3, txtOsEquip.getText());
            pst.setString(4, txtOsSerial.getText());
            pst.setString(5, txtOsDef.getText());
            pst.setString(6, txtOsServ.getText());
            pst.setString(7, txtOsTec.getText());
            pst.setString(8, txtOsVal.getText().replace(",", "."));
            pst.setString(9, txtCiId.getText());

            //verifica os campos obrigatórios
            if ((txtCiId.getText().isEmpty()) || (txtOsEquip.getText().isEmpty()) || (txtOsDef.getText().isEmpty())) {
                ...
                if (adicionado > 0) {
                    ...
                    txtCiId.setText(null);
                    txtOsEquip.setText(null);
                    txtOsSerial.setText(null);
    ...
    private void pesquisa_os() {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                txtOsSerial.setText(rs.getString(6));
                txtOsDef.setText(rs.getString(7));
                txtOsServ.setText(rs.getString(8));
                txtOsTec.setText(rs.getString(9));
                txtOsVal.setText(rs.getString(10));
                txtCiId.setText(rs.getString(11));
    ...
    private void alterar_os() {
        String sql = "update tbos set tipo=?,situacao=?,equipamento=?,serie=?,defeito=?,servico=?,tecnico=?,valor=? where os=?";
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, tipo);
            pst.setString(2, cbOsSit.getSelectedItem().toString());
            ...
            if ((txtCiId.getText().isEmpty()) || (txtOsEquip.getText().isEmpty()) || (txtOsDef.getText().isEmpty())) {
                ...
                if (adicionado > 0) {
                    ...
                    txtOsTec.setText(null);
                    txtOsVal.setText(null);
                    //habilita botões adicionar, tabela e campo de pesquisa
    ...
    private void excluir_os() {
        int confirma = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja escluir a OS?", "Atenção!", 
    ...
    private void initComponents() {
        ...
        txtOsSerial = new javax.swing.JTextField();
        ...
        setPreferredSize(new java.awt.Dimension(646, 435));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/iconfinder_search_48796.png"))); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(txtCiId, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE))
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txtOsEquip, javax.swing.GroupLayout.PREFERRED_SIZE, 278, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(jLabel6)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtOsSerial, javax.swing.GroupLayout.PREFERRED_SIZE, 199, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(cbOsSit, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel6)
                    .addComponent(txtOsSerial, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel8)
    ...
    private void rbtOrcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtOrcActionPerformed
        // TODO add your handling code here:
        //altera o valor d variavel tipo para 'orçamento'
        tipo = "Orçamento";
    ...
    private javax.swing.JTextField txtOsSerial;
